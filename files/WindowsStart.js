...
function StartHandler() {
  ...
  this.loadButtons = function () {
    ...
    this.buttonGroup.push(
      new StartButton("Windows Update", "Img_Program.PNG", none)
    );
    this.buttonGroup.push(
      new StartButton("Programme", "Img_Program.PNG", none)
    );
    this.buttonGroup.push(new StartButton("Dokumente", "Img_Order3.PNG", none));
    this.buttonGroup.push(
      new StartButton("Einstellungen", "Img_Settings.PNG", none)
    );
    ...
    this.buttonGroup.push(
      new StartButton("Ausführen...", "Img_Program.PNG", none)
    );
    this.buttonGroup.push(
      new StartButton("Beenden...", "Img_Stop.PNG", this.startFunctions.turnOff)
    );
