(() => {
    ...
    const t = new (function () {
        (this.initWindowEvents = function (t) {
            document.getElementById("id_windows").addEventListener("mousemove", (t) => {
                this.mouseMove(t);
            }),
    ...
    function e() {
        (this.desktop = document.getElementById("id_desktop")),
            ...
            (this.removeWindow = function (t) {
                document.getElementById(t).remove(), document.getElementById(`${t}mini`).remove();
            }),
            (this.webindowsLoadingScreen = function (t) {
                let e = document.getElementById("turnOff");
                (e.style.backgroundImage = "url('Assets/Img_LoadingWindows.PNG')"),
            ...
            (this.adjustZIndex = function (t) {
                ...
                t.classList.contains("winCl-ShortcutBtn") || (t.style["z-index"] = 2);
            }),
            (this.moveWindow = function (t, e, n) {
                (n.style.position = "absolute"), (n.style.left = Number(t - Number(n.dataset.width) / 2) + "px"), (n.style.top = e - 10 + "px");
            }),
            (this.showTurnOffScreen = function () {
                let t = document.getElementById("turnOff");
                (t.style.backgroundImage = "url('Assets/Img_ShutDown.PNG')"), (t.style.display = "block");
            }),
            (this.black = function () {
                let t = document.getElementById("turnOff");
                (t.style.backgroundImage = ""), (t.style.backgroundColor = "black");
            });
    }
    function n(t, e, n) {
        (this.name = t), (this.isFullScreen = !1), (this.isMinimized = !1), (this.html = e), (this.img = n);
    }
    function i() {
        (this.allApps = new Array()),
            ...
            (this.initAllApps = function () {
                let t = new Array(0),
                    e = {};
                (e = new n("Order Manager", "Apps/App_OrderManagerHTML.html", "ImgTrans_OrderManager.png")),
                    t.push(e),
                    (e = new n("Callback Sorter", "Apps/App_CallbackSorterHTML.html", "Img_Program.PNG")),
                    t.push(e),
                    (this.allApps = t);
            }),
            (this.isAppOpened = function (t) {
                for (let e = 0; e < this.openedApps.length; e++) if (this.openedApps[e].name == t) return !0;
                return !1;
            }),
            ...
            (this.appClosed = function (t) {
                for (let e = 0; e < this.openedApps.length; e++) this.openedApps[e].name == t && this.openedApps.splice(e, 1);
            }),
            (this.appHidden = function (t) {
                for (let e = 0; e < this.openedApps.length; e++) this.openedApps[e].name == t && (this.openedApps[e].isMinimized = !0);
            }),
            (this.appShown = function (t) {
                for (let e = 0; e < this.openedApps.length; e++) this.openedApps[e].name == t && (this.openedApps[e].isMinimized = !1);
            }),
            (this.isAppHidden = function (t) {
                for (let e = 0; e < this.openedApps.length; e++) if (this.openedApps[e].name == t) return this.openedApps[e].isMinimized;
                return !1;
            });
    }
    function s(t, e, n) {
    ...
    function o() {
        (this.buttonGroup = new Array(0)),
            (this.initStartButtons = function () {
                const e = void 0;
                this.buttonGroup.push(new s("Windows Update", "Img_Program.PNG", e)),
                    this.buttonGroup.push(new s("Programme", "Img_Program.PNG", e)),
                    this.buttonGroup.push(new s("Dokumente", "Img_Order3.PNG", e)),
                    this.buttonGroup.push(new s("Einstellungen", "Img_Settings.PNG", e)),
                    this.buttonGroup.push(new s("Suchen", "Img_Search.PNG", e)),
                    this.buttonGroup.push(new s("Hilfe", "Img_HowBook.PNG", e)),
                    this.buttonGroup.push(new s("Ausführen...", "Img_Program.PNG", e)),
                    this.buttonGroup.push(new s("Beenden...", "Img_Stop.PNG", t.turnOff)),
            ...
            (this.bindButtonStart = function () {
                document.addEventListener(
                    ...
                    (t) => {
                        ...
                        ("block" === e.style.display && !document.getElementById("windowStart").contains(t.target)) ||
                        (!document.getElementById("windowStart").contains(t.target) && !document.getElementById("buttonStart").contains(t.target))
                            ? (e.style.display = "none")
                            : (e.style.display = "block");
                    },
                    !1
        ...
        (this.draw = new e()),
            ...
            (this.init = function () {
                this.starter.initStartButtons(),
                    ...
                    this.initClock();
                for (let t = 0; t < this.apper.allApps.length; t++) this.draw.createShortcut(this.apper.allApps[t]);
            }),
            ...
            (this.tickTime = function () {
                let t = new Date();
                document.getElementById("id_clockTaskBar").innerHTML = String(t.getHours()) + ":" + String(t.getMinutes());
            }),
            (this.setSelectedWindow = function (t) {
                this.selectedWindow = document.getElementById(t);
            }),
            (this.drag = function (t) {
                if (null == t) return (this.isDragging = !1), void this.setSelectedWindow(void 0);
                this.setSelectedWindow(t), (this.isDragging = !0), null != d.selectedWindow && this.draw.adjustZIndex(this.selectedWindow);
            }),
            (this.drop = function () {
            ...
            (this.moveWindow = function (t) {
                this.isDragging &&
                    (t.clientX <= window.innerWidth && t.clientX >= 20 && (this.mouseX = t.clientX),
                    t.clientY <= window.innerHeight - 100 && t.clientY >= 10 && (this.mouseY = t.clientY),
                    this.draw.moveWindow(this.mouseX, this.mouseY, this.selectedWindow));
            }),
            (this.openApp = function (t) {
                this.apper.isAppOpened(t.name) || (this.draw.createWindow(t), this.apper.appOpened(t));
            }),
            (this.closeApp = function (t) {
                this.apper.isAppOpened(t) && (this.draw.removeWindow(t), this.apper.appClosed(t));
            }),
            (this.toggleHideApp = function (t) {
                if (this.apper.isAppHidden(t)) return this.draw.showWindow(t), void this.apper.appShown(t);
